...
public class OidcClientJson
{
    ...
    /// <summary>
    /// Gets or sets the reference to the default access token manager for the client.
    /// This refers to the manager that handles the access tokens for this client.
    /// </summary>
    [JsonPropertyName("defaultAccessTokenManagerRef")]
    public OidcAccessTokenManagerRef? OidcDefaultAccessTokenManagerRef { get; set; }

    /// <summary>
    /// Gets or sets the OIDC policy associated with the client.
    /// The policy governs rules such as session management, user identifiers, and logout behaviors.
    /// </summary>
    [JsonPropertyName("oidcPolicy")]
    public OidcPolicy? OidcPolicy { get; set; }

    /// <summary>
    /// Gets or sets the client authentication information for this OIDC client.
    /// </summary>
    [JsonPropertyName("clientAuth")]
    public OidcClientAuth? OidcClientAuth { get; set; }
}

/// <summary>
/// Represents a reference to the access token manager for an OIDC client.
/// </summary>
public class OidcAccessTokenManagerRef
{
    /// <summary>
    ...
    /// <summary>
    /// Gets or sets the unique identifier for the access token manager.
    /// </summary>
    [JsonPropertyName("id")]
    public string? Id { get; set; }

    /// <summary>
    /// Gets or sets the location or path where the access token manager is hosted or configured.
    /// </summary>
...
/// <summary>
/// Represents the OpenID Connect (OIDC) policy associated with a client.
/// </summary>
public class OidcPolicy
{
    ...
    /// <summary>
    /// Gets or sets the associated policy group for this policy.
    /// </summary>
    [JsonPropertyName("policyGroup")]
    public OidcPolicyGroup? OidcPolicyGroup { get; set; }

    /// <summary>
    /// Gets or sets a value indicating whether access session revocation API is granted.
    /// </summary>
    [JsonPropertyName("grantAccessSessionRevocationApi")]
    public bool GrantAccessSessionRevocationApi { get; set; }

    /// <summary>
    /// Gets or sets a value indicating whether session management API is granted for this client.
    /// </summary>
    [JsonPropertyName("grantAccessSessionSessionManagementApi")]
    public bool GrantAccessSessionSessionManagementApi { get; set; }

    /// <summary>
    /// Gets or sets the logout mode used for the client (e.g., redirect, iframe).
    /// </summary>
    [JsonPropertyName("logoutMode")]
    public string? LogoutMode { get; set; }

    /// <summary>
    /// Gets or sets a value indicating whether the client supports PingAccess logout.
    /// </summary>
    [JsonPropertyName("pingAccessLogoutCapable")]
    public bool PingAccessLogoutCapable { get; set; }

    /// <summary>
    /// Gets or sets a value indicating whether the client uses pairwise identifiers for users.
    /// </summary>
    [JsonPropertyName("pairwiseIdentifierUserType")]
    public bool PairwiseIdentifierUserType { get; set; }
}

/// <summary>
/// Represents a policy group in an OIDC context.
/// </summary>
public class OidcPolicyGroup
{
    /// <summary>
    /// Represents the primary key for the DTO (Data Transfer Object).
    /// </summary>
    ...
    /// <summary>
    /// Gets or sets the location or context of the policy group.
    /// </summary>
    [JsonPropertyName("location")]
    public string? Location { get; set; }
}
...
/// <summary>
/// Represents the client authentication configuration for an OIDC client.
/// </summary>
public class OidcClientAuth
{
    /// <summary>
    /// Represents the primary key for the DTO (Data Transfer Object).
    /// </summary>
    ...
    /// <summary>
    /// Gets or sets the authentication type for the client (e.g., secret, certificate).
    /// </summary>
    [JsonPropertyName("type")]
    public string? Type { get; set; }

    /// <summary>
    /// Gets or sets the encrypted secret associated with the client for authentication.
    /// </summary>
    [JsonPropertyName("encryptedSecret")]
    public string? EncryptedSecret { get; set; }

    /// <summary>
    /// Gets or sets a collection of secondary secrets for the client.
    /// These are additional secrets used in various authentication schemes.
    /// </summary>
    [JsonPropertyName("secondarySecrets")]
    public List<string>? SecondarySecrets { get; set; }
}