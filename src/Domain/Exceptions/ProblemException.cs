...
/// <summary>
/// Represents an exception that contains additional error information.
/// </summary>
[Serializable]
public class ProblemException : Exception
{
    ...
    /// <summary>
    /// Initializes a new instance of the <see cref="ProblemException"/> class with a specified error code and message.
    /// </summary>
