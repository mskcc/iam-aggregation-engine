...
[Table("Ping_IdentityLinking_Processing_Request_Archive")]
public class IdentityLinkingProcessingReqeustArchive
{
    /// <summary>
    ...
    /// <summary>
    /// Unique identifier for the identity linking processing request from the queue.
    /// </summary>
